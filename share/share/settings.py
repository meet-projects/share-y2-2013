...
STATICFILES_DIRS = (
    ...
    ("css", join(PROJECT_ROOT, 'share_app', 'static', 'css')),
    ("js", join(PROJECT_ROOT, 'share_app', 'static', 'js')),
    ("images", join(PROJECT_ROOT, 'share_app', 'static', 'images')),
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    join(PROJECT_ROOT, 'share_app', 'templates'),
)
